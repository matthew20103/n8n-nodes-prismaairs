			...
			if (items[0].json.hasOwnProperty('chatInput')) {
				...
				switch (prismaAIRSAction) {
					case 'allow':
							...
							if (typeof prompt_masked_data !== 'undefined' && typeof prompt_masked_data !== 'null' && typeof prompt_masked_data.data !== 'undefined' && typeof prompt_masked_data.data !== 'null' && typeof prompt_masked_data.data === 'string') {
								returnData.push({
									json: {
										sessionId: sessionId,
